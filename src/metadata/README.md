 ...
 * [PDRO.yml](PDRO.yml)
     * Determines how your purl.obolibrary.org/obo/PDRO/ redirects will be handled
     ...
     * Paste in the contents of [PDRO.yml](PDRO.yml)
 ...
 * [PDRO.md](PDRO.md)
     ...
     * Paste in the contents of [PDRO.md](PDRO.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
